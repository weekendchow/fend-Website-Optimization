...
function updatePositions() {
  ...
  //move phase calcutation into its own loop and add to array phases[]
  var phaseInt = document.body.scrollTop / 1250;
  var phases = [];
  for (var j = 0; j < 5; j++) {
    phases.push(Math.sin(phaseInt + (j % 5)));
  }
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  //generate number of pizzas based on the window height.
